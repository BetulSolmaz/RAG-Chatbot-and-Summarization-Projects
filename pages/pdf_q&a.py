...
def init_model(pdf):
    ...
    index = Chroma().from_documents(documents=pdf,
                                ...
                                persist_directory="/Users/betulsolmaz/Desktop/Streamlit_chatbot/vectorstore")

    loaded_index = Chroma(persist_directory="/Users/betulsolmaz/Desktop/Streamlit_chatbot/vectorstore",
